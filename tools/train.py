...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='./cfgs/kitti_models/voxel_rcnn_car_focal_multimodal.yaml', help='specify the config for training')
...
def main():
    ...
    logger.info(model)
    logger.info(summary(model))    ###para
